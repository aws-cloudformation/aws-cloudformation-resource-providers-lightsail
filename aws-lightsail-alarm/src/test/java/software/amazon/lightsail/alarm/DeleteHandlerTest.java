...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        doReturn(alarmHandler)
                .when(deleteHandler).getAlarmHandler(any(), any(), any(), any(), any());

        when(alarmHandler.handleDelete(any()))
        ...
        verify(alarmHandler, times(1)).handleDelete(ProgressEvent.progress(model, callbackContext));
