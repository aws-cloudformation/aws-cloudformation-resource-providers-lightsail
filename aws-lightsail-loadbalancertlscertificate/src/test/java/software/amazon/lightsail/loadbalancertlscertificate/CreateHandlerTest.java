...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        doReturn(loadBalancerTlsCertificateHandler)
                .when(createHandler).getLoadBalancerTlsCertificateHandler(any(), any(), any(), any(), any());
        doReturn(updateHandler)
                .when(createHandler).getUpdateHandler();

        when(loadBalancerTlsCertificateHandler.handleCreate(any()))
        ...
        verify(loadBalancerTlsCertificateHandler, times(1)).handleCreate(ProgressEvent.progress(model, callbackContext));
