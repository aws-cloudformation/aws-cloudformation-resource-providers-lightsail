...
public class UpdateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        doReturn(loadBalancerTlsCertificateHandler)
                .when(updateHandler).getLoadBalancerTlsCertificateHandler(any(), any(), any(), any(), any());
        doReturn(readHandler)
                .when(updateHandler).getReadHandler();

        when(loadBalancerTlsCertificateHandler.handleUpdate(any()))
        ...
        verify(loadBalancerTlsCertificateHandler, times(1)).handleUpdate(ProgressEvent.progress(model, callbackContext));
