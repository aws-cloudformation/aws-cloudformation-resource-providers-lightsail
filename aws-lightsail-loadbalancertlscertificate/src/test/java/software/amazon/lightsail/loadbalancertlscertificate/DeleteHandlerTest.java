...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    @Mock
    private LoadBalancerTlsCertificateHandler loadBalancerTlsCertificateHandler;
    ...
    public void setup() {
        ...
        loadBalancerTlsCertificateHandler = mock(LoadBalancerTlsCertificateHandler.class);
    }
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        doReturn(loadBalancerTlsCertificateHandler)
                .when(deleteHandler).getLoadBalancerTlsCertificateHandler(any(), any(), any(), any(), any());

        when(loadBalancerTlsCertificateHandler.handleDelete(any()))
        ...
        verify(loadBalancerTlsCertificateHandler, times(1)).handleDelete(ProgressEvent.progress(model, callbackContext));
