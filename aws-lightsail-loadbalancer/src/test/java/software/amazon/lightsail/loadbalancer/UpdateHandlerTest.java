...
import software.amazon.lightsail.loadbalancer.helpers.handler.TagsHandler;
...
public class UpdateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        doReturn(loadBalancerHandler)
                .when(updateHandler).getLoadBalancerHandler(any(), any(), any(), any(), any());
        ...
        when(loadBalancerHandler.handleUpdate(any()))
        ...
        verify(loadBalancerHandler, times(1)).handleUpdate(ProgressEvent.progress(model, callbackContext));
