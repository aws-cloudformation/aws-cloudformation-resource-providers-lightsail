...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void setup() {
        ...
        containerHandler = mock(ContainerHandler.class);
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        doReturn(containerHandler)
                .when(createHandler).getContainerHandler(any(), any(), any(), any(), any());
        doReturn(updateHandler)
                .when(createHandler).getUpdateHandler();

        when(containerHandler.handleCreate(any()))
        ...
        verify(containerHandler, times(1)).handleCreate(ProgressEvent.progress(model, callbackContext));
