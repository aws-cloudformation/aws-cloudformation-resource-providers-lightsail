...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        doReturn(containerHandler)
                .when(deleteHandler).getContainerHandler(any(), any(), any(), any(), any());

        when(containerHandler.handleDelete(any()))
        ...
        verify(containerHandler, times(1)).handleDelete(ProgressEvent.progress(model, callbackContext));
