...
public class UpdateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        doReturn(containerHandler)
                .when(updateHandler).getContainerHandler(any(), any(), any(), any(), any());
        ...
        when(containerHandler.handleUpdate(any()))
        ...
        verify(containerHandler, times(1)).handleUpdate(ProgressEvent.progress(model, callbackContext));
