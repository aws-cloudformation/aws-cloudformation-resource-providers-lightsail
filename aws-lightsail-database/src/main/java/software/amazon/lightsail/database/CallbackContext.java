...
public class CallbackContext extends StdCallbackContext {
    ...
    public static String POST_CHECK_UPDATE = "postCheckUpdate";
    public static String POST_CHECK_UPDATE_PARAMS = "postCheckUpdateParams";
    ...
    private Integer postUpdateWaitCount = 1;
    ...
    public boolean isWaitCountReached(final String key) {
        ...
        if (key.equalsIgnoreCase(POST_CHECK_UPDATE) || key.equalsIgnoreCase(POST_CHECK_UPDATE_PARAMS)) {
            maxWait = this.postUpdateWaitCount;
        }
