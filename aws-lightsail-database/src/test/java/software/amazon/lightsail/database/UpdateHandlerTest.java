...
public class UpdateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest() {
        ...
        doReturn(databaseHandler)
                .when(updateHandler).getDatabaseHandler(any(), any(), any(), any(), any());
        ...
        when(databaseHandler.handleUpdate(any()))
        ...
        verify(databaseHandler, times(1)).handleUpdate(ProgressEvent.progress(model, callbackContext));
