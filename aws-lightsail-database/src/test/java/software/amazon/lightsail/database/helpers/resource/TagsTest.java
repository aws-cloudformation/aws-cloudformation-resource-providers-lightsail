...
import software.amazon.lightsail.database.Tag;
...
public class TagsTest {
    ...
    @Test
    public void update() {
        val basicResponse = GetRelationalDatabaseResponse.builder()
                .relationalDatabase(software.amazon.awssdk.services.lightsail.model.RelationalDatabase.builder().state("available")
                        .tags(ImmutableSet.of(
