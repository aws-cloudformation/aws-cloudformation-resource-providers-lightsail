...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        doReturn(distributionHandler)
                .when(deleteHandler).getDistributionHandler(any(), any(), any(), any(), any());

        when(distributionHandler.handleDelete(any()))
        ...
        verify(distributionHandler, times(1)).handleDelete(ProgressEvent.progress(model, callbackContext));
