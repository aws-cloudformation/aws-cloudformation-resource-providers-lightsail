...
import software.amazon.lightsail.distribution.Tag;
...
public class TagsTest {
    ...
    @Test
    public void update() {
        val basicResponse = GetDistributionsResponse.builder()
                .distributions(LightsailDistribution.builder().defaultCacheBehavior(CacheBehavior.builder().
                        behavior(BehaviorEnum.CACHE).build())
                        .tags(ImmutableSet.of(
