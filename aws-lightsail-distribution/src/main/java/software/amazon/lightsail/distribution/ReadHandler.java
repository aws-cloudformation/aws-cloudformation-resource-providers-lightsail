...
public class ReadHandler extends BaseHandlerStd {
    ...
    protected ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        this.logger = logger;
        val distribution = getDistribution(request, proxyClient, logger);

        return proxy
                .initiate("AWS-Lightsail-Distribution::Read", proxyClient, request.getDesiredResourceState(), callbackContext)
