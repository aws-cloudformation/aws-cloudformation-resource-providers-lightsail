...
public abstract class BaseHandlerStd extends BaseHandler<CallbackContext> {
  ...
  public static ProgressEvent<ResourceModel, CallbackContext> handleError(final Exception e,
    ...
    if (e instanceof AwsServiceException) {
      ...
      // GetDistributions returns InvalidInputException instead of NotFoundException when the resource is not found.
      // Returning CfnNotFoundException in this case as Delete expects it.
      if (e.getMessage().contains("Requested resource not found")) {
        logger.log("Converting InvalidInputException to NotFoundException.");
