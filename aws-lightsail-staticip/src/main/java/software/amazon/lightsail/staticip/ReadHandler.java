...
public class ReadHandler extends BaseHandlerStd {
    ...
    protected ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        this.logger = logger;
        val staticIp = getStaticIp(request, proxyClient, logger);

        return proxy.initiate("AWS-Lightsail-StaticIp::Read", proxyClient, request.getDesiredResourceState(), callbackContext)
