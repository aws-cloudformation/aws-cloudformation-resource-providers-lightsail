...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest() {
        ...
        doReturn(staticIpHandler)
                .when(createHandler).getStaticIpHandler(any(), any(), any(), any(), any());
        ...
        when(staticIpHandler.handleCreate(any()))
        ...
        verify(staticIpHandler, times(1)).handleCreate(ProgressEvent.progress(model, callbackContext));
