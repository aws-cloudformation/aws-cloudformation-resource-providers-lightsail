...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        doReturn(certificateHandler)
                .when(deleteHandler).getCertificateHandler(any(), any(), any(), any(), any());

        when(certificateHandler.handleDelete(any()))
        ...
        verify(certificateHandler, times(1)).handleDelete(ProgressEvent.progress(model, callbackContext));
