...
import software.amazon.lightsail.certificate.Tag;
...
public class TagsTest {
    ...
    @Test
    public void update() {
        val basicResponse = GetCertificatesResponse.builder()
                .certificates(CertificateSummary.builder()
                        .certificateDetail(software.amazon.awssdk.services.lightsail.model.Certificate.builder().status("ISSUED").build())
                        .tags(ImmutableSet.of(
