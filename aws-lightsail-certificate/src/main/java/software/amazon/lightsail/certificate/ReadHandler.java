...
public class ReadHandler extends BaseHandlerStd {
    ...
    protected ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        this.logger = logger;
        val certificate = getCertificate(request, proxyClient, logger);

        return proxy
                .initiate("AWS-Lightsail-Certificate::Read", proxyClient, request.getDesiredResourceState(), callbackContext)
