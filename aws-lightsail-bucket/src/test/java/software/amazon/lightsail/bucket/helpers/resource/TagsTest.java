...
import software.amazon.lightsail.bucket.Tag;
...
public class TagsTest {
    ...
    @Test
    public void update() {
        val basicResponse = GetBucketsResponse.builder()
                .buckets(Arrays.asList(software.amazon.awssdk.services.lightsail.model.Bucket.builder()
                        ...
                        .resourcesReceivingAccess(ResourceReceivingAccess.builder().name("testInstance").resourceType("Instance").build())
                        .objectVersioning("Enabled").tags(ImmutableSet.of(
