...
import software.amazon.lightsail.bucket.helpers.handler.TagsHandler;
...
public class UpdateHandlerTest extends AbstractTestBase {
    ...
    public void setup() {
        ...
        bucketHandler = mock(BucketHandler.class);
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        doReturn(bucketHandler)
                .when(updateHandler).getBucketHandler(any(), any(), any(), any(), any());
        ...
        when(bucketHandler.handleUpdate(any()))
        ...
        verify(bucketHandler, times(1)).handleUpdate(ProgressEvent.progress(model, callbackContext));
