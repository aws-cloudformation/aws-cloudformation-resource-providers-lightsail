...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        doReturn(bucketHandler)
                .when(deleteHandler).getBucketHandler(any(), any(), any(), any(), any());

        when(bucketHandler.handleDelete(any()))
        ...
        verify(bucketHandler, times(1)).handleDelete(ProgressEvent.progress(model, callbackContext));
