...
class TagsHandlerTest {
    ...
    private TagsHandler testTagsHandler;
    ...
    public void setup() {
        ...
        testTagsHandler = new TagsHandler(mock(AmazonWebServicesClientProxy.class), mock(CallbackContext.class),
    ...
    public void testDelete() {
        try {
            testTagsHandler.delete(progressEvent);
            fail();
    ...
    public void testPreDelete() {
        try {
            testTagsHandler.preDelete(progressEvent);
            fail();
        } catch (UnsupportedOperationException e) {
            // pass the exception
        }
    ...
    public void testCreate() {
        try {
            testTagsHandler.create(progressEvent);
            fail();
        } catch (UnsupportedOperationException e) {
            // pass the exception
        }
    ...
    public void testPreCreate() {
        try {
            testTagsHandler.preCreate(progressEvent);
            fail();
        } catch (UnsupportedOperationException e) {
            // pass the exception
        }
