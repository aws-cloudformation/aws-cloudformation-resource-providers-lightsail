...
public class ReadHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(sdkClient.getInstance(any(GetInstanceRequest.class))).thenReturn(GetInstanceResponse.builder()
                .instance(Instance.builder().build()).build());
    ...
    public void handleRequest_SimpleSuccessNoResponse() {
        ...
        when(sdkClient.getInstance(any(GetInstanceRequest.class))).thenReturn(null);
    ...
    public void handleRequest_ErrorHandling() {
        ...
        doThrow(InvalidInputException.builder().build()).when(sdkClient).getInstance(any(GetInstanceRequest.class));
