...
class NetworkHandlerTest {
    ...
    private NetworkHandler testNetwork;
    ...
    public void setup() {
        ...
        testNetwork = new NetworkHandler(mock(AmazonWebServicesClientProxy.class), mock(CallbackContext.class),
    ...
    public void testDelete() {
        try {
            testNetwork.delete(progressEvent);
            fail();
    ...
    public void testPreDelete() {
        try {
            testNetwork.preDelete(progressEvent);
            fail();
        } catch (UnsupportedOperationException e) {
            // pass the exception
        }
    ...
    public void testCreate() {
        try {
            testNetwork.create(progressEvent);
            fail();
        } catch (UnsupportedOperationException e) {
            // pass the exception
        }
    ...
    public void testPreCreate() {
        try {
            testNetwork.preCreate(progressEvent);
            fail();
        } catch (UnsupportedOperationException e) {
            // pass the exception
        }
