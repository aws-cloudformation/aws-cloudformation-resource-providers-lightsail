...
class DiskHandlerTest {

    private DiskHandler testDisk;
    ...
    public void setup() {
        ...
        testDisk = new DiskHandler(mock(AmazonWebServicesClientProxy.class), mock(CallbackContext.class),
    ...
    public void testPreDelete() {
        try {
            testDisk.preDelete(progressEvent);
            fail();
        } catch (UnsupportedOperationException e) {
            // pass the exception
        }
    ...
    public void testPreCreate() {
        try {
            testDisk.preCreate(progressEvent);
            fail();
        } catch (UnsupportedOperationException e) {
            // pass the exception
        }
